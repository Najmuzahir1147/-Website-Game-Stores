                ...
                <div class="grid gap-8">
                    <div id="back-div" class="bg-gradient-to-r from-purple to-blue-500 rounded-[26px] m-4">
                        ...
                        <form action="#" method="post" class="space-y-4">
                            ...
                            <span class="bg-left-bottom bg-gradient-to-r text-sm from-purple to-blue-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
                                Forget your password?
                            </span>
                            </a>
                            <button
                            class="bg-gradient-to-r dark:text-gray-300 from-purple to-blue-500 shadow-lg mt-6 p-2 text-white rounded-lg w-full hover:scale-105 hover:from-purple-500 hover:to-blue-500 transition duration-300 ease-in-out"
                            type="submit"
                            >
                            LOG IN
                            </button>
                        ...
                        <div class="flex flex-col mt-4 items-center justify-center text-sm">
                            ...
                            <a class="group text-blue-400 transition-all duration-100 ease-in-out" href="#">
                                <span class="bg-left-bottom bg-gradient-to-r from-purple to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">Sign Up</span>
                            </a>
                            </h3>
                        </div>
